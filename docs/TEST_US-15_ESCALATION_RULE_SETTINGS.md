...
4. Xác minh giao diện:
   ...
   - Danh sách 5 loại sự kiện có cảnh báo: _Phát hiện cháy / khói (P0)_, _Phát hiện té ngã (P1)_, _Xâm nhập vùng cấm (P1)_, _Người lạ mặt (P2)_, _Quá hạn an sinh (P2)_.
   - Thẻ _Quá hạn an sinh (WELLNESS_TIMEOUT)_ bị khóa ô nhập threshold và hiển thị ghi chú "không áp dụng confidence".
